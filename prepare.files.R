prepare.files=function(df,cov){
  #col_cov=c('Age','Sex','SCZ_PRS')
  col_cov=c('SubjID','Age','Sex','SCZ_PRS')
  ...
  # Age was not floored for the current sample (ALSPAC-SCZ-RbG) to preserve limited sample variation in age. 
  ...
  # NB. All successfully processed scans for the ALSPAC-PE sample have valid IDP values. Thus, NO median imputation was performed in this sample.
