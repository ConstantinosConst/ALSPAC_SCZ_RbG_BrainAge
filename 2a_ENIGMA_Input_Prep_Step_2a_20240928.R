...
###### Script 2a: Preparing ALSPAC-SCZ-RbG imaging dataset for brain age prediction using the ENIGMA model - step 2a
...
ALSPAC_SCZ_RbG_Imaging <- read.csv("ALSPAC_SCZ_RbG_Imaging.csv", header = TRUE)
...
ALSPAC_SCZ_RbG_IDP_Missing <- ALSPAC_SCZ_RbG_Imaging %>% filter(is.na(CorticalQC) | is.na(SubCorticalQC))
# Exclude those participants from the original dateset
ALSPAC_SCZ_RbG_Imaging <- anti_join(ALSPAC_SCZ_RbG_Imaging, ALSPAC_SCZ_RbG_IDP_Missing, by="SubjID")
...
Covariates <- ALSPAC_SCZ_RbG_Imaging[,c("SubjID", "SCZ_PRS", "Age",                               
                                   "Sex", "HAND", "BW",                                 
                                   "IQ_8", "SDQ_ES_17", "AUDIT_18",                          
                                   "PE_18_3Level", "PsyDis_18", "CASTgroup_20",                       
                                   "MFQ_22", "GAD_24", "PE_24_4level", "BMI_24", 
...
## Cortical thickness                                   
CorticalMeasures_ALSPAC_ThickAvg  <- ALSPAC_SCZ_RbG_Imaging[, c("SubjID", "l_bankssts_thickavg", "l_caudalanteriorcingulate_thickavg", "l_caudalmiddlefrontal_thickavg",    
...
CorticalMeasures_ALSPAC_SurfAvg <-ALSPAC_SCZ_RbG_Imaging[, c("SubjID", "l_bankssts_surfavg", "l_caudalanteriorcingulate_surfav", "l_caudalmiddlefrontal_surfavg",   
...
## Subcortical Volumes
SubcorticalMeasures_ALSPAC_VolAvg <- ALSPAC_SCZ_RbG_Imaging[, c("SubjID", "llatvent", "rlatvent","lthal", "rthal", 
