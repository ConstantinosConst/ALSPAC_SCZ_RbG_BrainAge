...
###### Script 2b: Preparing ALSPAC-SCZ-RbG imaging dataset for brain age prediction using the ENIGMA model - step 2b
...
-females_raw.csv\n
-males_raw.csv.\n
These should be uploaded on the PHOTON-AI platform as described in the README file.
